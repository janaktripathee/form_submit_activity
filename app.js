...
// one way
	...
	app.put('/animals-update', function(req, res){
		connection.query('UPDATE animals SET animal_name = (?) WHERE id = (?)', [req.body.animal_name, req.body.animal_id],function (error, results, fields) {
